...
const CurrencyConverter = () => {
  ...
  return (
    <div className="convert-background flex justify-center pt-[6rem] text-4xl text-zinc-200 bg-[#000322] lg:h-[140vh] h-[160vh] w-[100%]">
      ...
      <div className="Convertercard gap-[10px] lg:gap-0 lg:mt-[7vh] mt-[3vh] lg:w-[75vw] w-[95vw] h-[92vh] lg:h-[72vh] rounded-[30px] flex flex-col justify-evenly items-center">
        ...
        <div className="form">
          <form className="flex items-center lg:items-start justify-center flex-col lg:flex-row lg:gap-14 w-[100%]">
            ...
            <div onClick={handleSwap} className="currency-swaper relative top-[0.9rem] lg:top-6 flex justify-center items-center cursor-pointer swap w-[50px] h-[50px] rounded-[100%] text-zinc-300">⇆</div>
            <CurrencySelect
              label='To'
