...
const Wellcome = () => {
  return (
    <div className="home-background flex flex-col pt-[6rem] text-4xl text-zinc-200 bg-[#000322] h-[110vh] lg:h-[140vh] w-[100%]">
      <div className='w-[100%] flex lg:flex-row-reverse flex-col-reverse justify-evenly px-4 lg:px-12 mt-8'>
        <div className="wellcome-text px-10 lg:items-start items-center py-10 flex flex-col lg:w-[57vw] w-[100%] h-max lg:mt-[14vh] lg:mr-[20vw]">
